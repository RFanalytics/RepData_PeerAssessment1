...
###  **Question 1 answer:**  
#### The mean number of steps taken per day is `r as.integer(mean(day.steps$steps.per.day))`.
...
###  **Question 2 answer:**  
#### The maximum number of steps occurs at interval `r max.interval`
...
**There are `r missing.data` rows with missing data**
...
**The mean number of steps taken per day using the imputed is `r as.integer(mean(fix.day.steps$sum.steps))`.**  

**The median number of steps taken per day using the imputed is `r as.integer(median(fix.day.steps$sum.steps))`.**
